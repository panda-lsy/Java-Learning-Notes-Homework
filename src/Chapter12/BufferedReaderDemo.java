package Chapter12;
        ...
        public class BufferedReaderDemo {
            ...
            public static void main(String[] args) {
                // Using try-with-resources to automatically close both FileReader and BufferedReader
                // 使用try-with-resources自动关闭FileReader和BufferedReader
                try (BufferedReader reader = new BufferedReader(new FileReader("src/Chapter12/test.txt"))) {
